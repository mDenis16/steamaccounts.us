...
namespace csgo.core
{
    public static class requestsHelper
    {
        ...
        public class request
        {
            ...
            public int blacklistedRequestsCount { get; set; }
            public request( ) { }
            public request(string ip, string path)
            {
                this.ip = ip;
                this.blacklist = false;
                this.blackListedTime = DateTime.Now.AddHours( -24 );
                this.lastRequestTime = DateTime.Now;
                this.path = path;
            }
        }
        public static List<request> spamList = new List<request>();
